...
public class EquipmentConsoleAgentAdjustmentsStepDef {
    ...
    public void run_Test_for_on_Browser_for_Equipment_Console_and_Enter_the_url_for_Equipment_Console(String environment1, String browser) {
        BrowserDriverInitialization browserDriverInitialization = new BrowserDriverInitialization();
    ...
    public void Locate_a_Record_from_Database_Agent_Status_must_have_a_Status_of_Agent_Review_or_Corp_Review(String environment, String tableName1, String createdDate) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        // SQL#1
        System.out.println("=========================================");
